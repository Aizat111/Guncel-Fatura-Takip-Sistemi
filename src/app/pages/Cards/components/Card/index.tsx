...
const cardBackgroundName = () => {
  return `${toAbsoluteUrl('/media/cards/credit_card_bg.jpeg')}`;
};
      ...
      <div className="card-item__side -front">
        ...
        <div className="card-item__wrapper">
          <div className="card-item__top">
            <img
              src={toAbsoluteUrl('/media/cards/chip.png')}
              alt=""
            ...
            <div className="card-item__type">
              <img
                alt={useCardType}
                src={toAbsoluteUrl(`/media/cards/${useCardType}.png`)}
          ...
          <div className="card-item__content">
            ...
            <div className="card-item__date">
              <label className="card-item__dateTitle">Valid Thru</label>
